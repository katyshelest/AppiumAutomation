...
class SearchPageObject(driver: AppiumDriver<WebElement>): MainPageObject(driver) {
    private val BUTTON_SKIP = "id:org.wikipedia:id/fragment_onboarding_skip_button"
    ...
    fun clickButtonSkip() {
        this.waitForElementAndClick(BUTTON_SKIP, "Cannot find and click button Skip", 5)
    }
    ...
    fun waitForCancelButtonToDisappear() {
        this.waitForElementNotPresent(SEARCH_CANCEL_BUTTON, "Search line button is still present", 5)
    }
